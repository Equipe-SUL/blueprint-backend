...
MAPA_CAMADAS = {
    "PILAR":    {"type": "pilar",    "description": "Pilar de concreto armado",    "campo_qty": "area_total_m2",       "unidade": "m2"},
    "VIGA":     {"type": "viga",     "description": "Viga de concreto armado",     "campo_qty": "comprimento_total_m", "unidade": "m"},
    "ESTACA":   {"type": "estaca",   "description": "Estaca de concreto armado",   "campo_qty": "area_total_m2",       "unidade": "m2"},
    "LAJE":     {"type": "laje",     "description": "Laje de concreto armado",     "campo_qty": "area_total_m2",       "unidade": "m2"},
    "FUNDACAO": {"type": "fundacao", "description": "Funda├º├úo de concreto armado", "campo_qty": "area_total_m2",       "unidade": "m2"},
    "PAREDE":   {"type": "parede",   "description": "Alvenaria de veda├º├úo",        "campo_qty": "area_total_m2",       "unidade": "m2"},
}
...
def adaptar_memorial_para_orcamento(relatorio_etapa1: dict) -> List[Dict]:
    ...
    for idx, (camada, dados) in enumerate(resumo.items(), start=1):
        ...
        if config:
            ...
            # Camada desconhecida: usa o melhor valor dispon├¡vel
            tipo = camada.lower()
